---
name: setup-i18n-lint
description: Set up i18n linting with i18n-tasks and rubocop-i18n for a Rails project. Use when adding translation quality checks.
...
Create the file using [i18n-tasks.yml.template](i18n-tasks.yml.template).
