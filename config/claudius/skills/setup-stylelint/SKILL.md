...
description: Set up stylelint for CSS/SCSS linting in a Rails project. Use when adding stylesheet quality checks.
...
Create the file using [stylelintrc.yml.template](stylelintrc.yml.template).
