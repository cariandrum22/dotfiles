...
let
  ...
  downloadUrl = "https://downloads.cursor.com/production/8f2a112cb2845a97b75fd932ea5c470579ca4063/linux/x64/Cursor-3.17.21-x86_64.AppImage";

  src = pkgs.fetchurl {
    url = downloadUrl;
    hash = "sha256-V6G2huPD5TGbZ3MEfotw5phYBoyGe6+SYWTYpU3QNZ0=";
  };
